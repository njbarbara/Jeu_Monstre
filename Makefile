exosae: sae.o Testsae.o affichage.o score.o joueur.o monstre.o partie.o attaque.o
	gcc sae.o Testsae.o affichage.o score.o joueur.o monstre.o partie.o attaque.o -o exosae
